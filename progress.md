...
- Wrote `docs/prd.md` and `docs/tasks.md`.
- Chose a Node.js CLI MVP to reduce setup time.
- Implemented `check` and `probe` commands in `src/cli.js`.
- Added valid/broken fixtures and fake/crash process fixtures under `examples/`.
